  ...
  return (
    <div>
      ...
      <div className="snap-landing-page">
        {/* HERO */}
        <AtmosphericSection variant="beach" parallaxStrength="subtle" className="snap-landing-section">
        ...
        {/* WHY CHEAPSTAYS */}
        <AtmosphericSection variant="neighborhood" parallaxStrength="subtle" className="snap-landing-section">
        ...
        {/* DESTINATIONS */}
        <AtmosphericSection variant="city" parallaxStrength="subtle" className="snap-landing-section">
